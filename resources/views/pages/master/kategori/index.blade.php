...
@section('content')
<div x-data="{ openModal: false, editMode: false, form: { id: null, nama_kategori: '' } }">

    <div class="flex justify-between items-center mb-4">
        <h1 class="text-xl font-bold">Master Kategori</h1>

        <button @click="openModal = true; editMode = false; form = { id: null, nama_kategori: '' }"
            ...
            <tbody>
                ...
                <tr class="border-t">
                    ...
                    <td class="p-2 flex gap-2">
                        <button
                            @click="openModal = true; editMode = true; form = { id: {{ $item->id }}, nama_kategori: '{{ $item->nama_kategori }}' }"
    ...
    <div x-show="openModal"
        ...
        <div class="bg-white p-6 rounded w-96">
            <h2 class="text-lg font-bold mb-4"
                x-text="editMode ? 'Edit Kategori' : 'Tambah Kategori'"></h2>
